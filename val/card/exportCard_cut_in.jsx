...
/**********************************************************/
//var targetFolder = new Folder("~/works/gra2/purple/design/card/cut_in/");
var targetFolder = new Folder("~/Desktop/card/cut_in/");

/**********************************************************/

var exportObj = [
//sp用
{path:root_sp +"cut_in", width:480, quality:20},
//fp用
{path:root_fp +"cut_in", width:240, quality:20},
];
